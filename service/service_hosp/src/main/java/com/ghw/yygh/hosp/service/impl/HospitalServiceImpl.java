...
import com.ghw.yygh.cmn.client.DictFeignClient;
import com.ghw.yygh.hosp.repository.HospitalRepository;
...
public class HospitalServiceImpl implements HospitalService {
    ...
    //医院列表(条件查询分页)
    @Override
    public org.springframework.data.domain.Page<Hospital> selectHospPage(Integer page, Integer limit, HospitalQueryVo hospitalQueryVo) {
        //创建pageable对象
